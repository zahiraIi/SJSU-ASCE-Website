  ...
  const officers: Officer[] = [
    {
      name: "Ankush Bhatia",
      role: "President",
      image: "/images/Photos/New Officer Photos/Ankush Bhatia/ankush.jpeg",
    ...
    },
    {
      ...
      role: "Vice President",
      image: "/images/Photos/New Officer Photos/Stephanie/stephanie.jpg",
    ...
    },
    {
      ...
      role: "Secretary",
      image: "/images/Photos/New Officer Photos/Asmae/asma asce.jpg",
    ...
    },
    {
      name: "Ben Pham",
      role: "Co-Treasurer",
      image: "/images/Photos/New Officer Photos/Ben/d4c39421-4001-41d8-82cd-6ac0fa4c0ade.jpg",
    ...
    },
    {
      name: "Yaser Osman",
      role: "Co-Treasurer",
      image: "/images/Photos/New Officer Photos/Yaser/f1af8a86-dddd-4270-b38a-6fdb16b0b393.jpg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Maria/maria.jpeg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Loraelyne Gapasin/Loraelyne Gapasin.JPG",
    ...
    },
    {
      name: "Jamie Lee",
      role: "Networking Coordinator Assistant",
      image: "/images/Photos/New Officer Photos/Jamie/fb4f7744-c9b1-4e01-9a3a-3c7a70567696.jpg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Del/del.jpg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Asa/b4b92669-664b-423a-8a66-daab75c70f0f.jpg",
    ...
    },
    {
      ...
      role: "Mid-Pac Chair",
      image: "/images/Photos/New Officer Photos/April/f113a098-7ae1-42f6-a4db-8646b671631d.jpg",
    ...
    },
    {
      name: "Sonia Guzman",
      role: "Media Officer",
      image: "/images/Photos/New Officer Photos/Sonia/dddf7369-c4f1-40b8-a0a5-1acdd56f1998.jpg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Yasmin/yasmin.jpg",
    ...
    },
    {
      name: "Ismael Cruz",
      role: "Safety Officer",
      image: "/images/Photos/New Officer Photos/Ismael Cruz/Ismael Cruz.JPG",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Abdul/abdul.jpg",
    ...
    },
    {
      ...
      image: "/images/Photos/New Officer Photos/Alma/85f444a7-1db8-4102-ab6e-f44eacf93e2f.jpg",
      ...
      
    {
      ...
      image: "/images/ASCELOGO/officer.jpg", // Placeholder image
      ...
      <div className="container-custom px-4 mx-auto relative z-10">
        ...
        >
          {filteredOfficers.map((officer, index) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden bg-primary/10 flex items-center justify-center">
                ...
                <img 
                  src={getImageUrl(officer.image)}
                  alt={`${officer.name} - ${officer.role}`}
                  className="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-500 ease-out hover:scale-105"
                  onError={(e) => {
                    // Fallback to logo if image fails to load
                    e.currentTarget.src = "/images/ASCELOGO/officer.jpg";
                  }}
                  loading="lazy"
                  decoding="async"
                />
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Interested in Becoming an Officer?</h2>
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              ASCE officer positions provide valuable leadership experience and networking opportunities.
              Elections are held annually in the spring semester, with nominations beginning in March.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link 
                href="/membership" 
                className="btn btn-outline bg-white border-2 border-primary text-primary hover:bg-primary hover:text-white"
              >
                Join ASCE
              </Link>
            </div>
